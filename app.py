...
from frames import Dashboard, CustomerBooking, CustomerDetails, CurrencyConverter, Staff, NumberofMembers, \
    Services, Feedback
...
class App(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        self.title_font = ('Century Gothic Bold', 15)
        self.title('Denko | Hotel Management System')
        ...
        style.configure('BG.TLabel', background='gold')
        style.configure('BB.TLabel', background='#3b3b3b')
        ...
        self.frames = dict()
        for fr in (Dashboard, CustomerBooking, CustomerDetails, CurrencyConverter, Staff, NumberofMembers,
                   Services, Feedback):
