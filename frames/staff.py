...
from frames.staff_hash_table import AlgoHashTable
...
class Staff(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        list_of_dictionary = [
            {'Staff Type': 'Room Cleaning', 'Staff ID': 231, 'Name': 'Sameer', 'CNIC': 432219281192221,
             'Phone': 3214729643, 'Address': 'Karachi'},
        ...
        left_frame = ttk.Frame(both_frames, style='BB.TFrame', padding=(30, 15, 30, 15))
        self.side_frame = ttk.Frame(left_frame, style='BB.TFrame')
        right_frame = ttk.Frame(both_frames, style='BB.TFrame', padding=(30, 15, 30, 15))
        button_frame = ttk.Frame(frame, padding=(30, 15, 30, 15), style='BB.TFrame')
        both_button_frames = ttk.Frame(button_frame, style='BB.TFrame')

        self.denko_logo = PhotoImage(file='images/logo.png')
