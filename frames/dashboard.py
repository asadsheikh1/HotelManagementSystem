...
class Dashboard(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        customer_booking_photo_image = PhotoImage(file='images/customer_booking.png')
        self.customer_booking_photo = customer_booking_photo_image.subsample(4, 4)
        ...
        self.customer_details_photo = customer_details_photo_image.subsample(4, 4)
        ...
        self.currency_converter_photo = currency_converter_photo_image.subsample(4, 4)
        ...
        staff_details_photo_image = PhotoImage(file='images/staff_details.png')
        self.staff_details_photo = staff_details_photo_image.subsample(4, 4)
        ...
        number_of_members_photo_image = PhotoImage(file='images/number_of_members.png')
        self.number_of_members_photo = number_of_members_photo_image.subsample(4, 4)
        ...
        services_photo_image = PhotoImage(file='images/services.png')
        self.services_photo = services_photo_image.subsample(4, 4)
        ...
        self.feedback_photo = feedback_photo_image.subsample(4, 4)
