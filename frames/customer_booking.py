...
class CustomerBooking(ttk.Frame):
    def __init__(self, parent, controller):
        ...
        customer_frame = ttk.Frame(frame, padding=(30, 15, 30, 15), style='BB.TFrame')
        enqueue_frame = ttk.Frame(customer_frame, padding=(0, 10, 0, 10), style='BB.TFrame')
        room_frame = ttk.Frame(customer_frame, padding=(0, 10, 0, 10), style='BB.TFrame')
        self.selected_room_frame = ttk.Frame(frame, padding=(30, 15, 30, 15), style='BB.TFrame')
